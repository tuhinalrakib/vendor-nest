    ...
    <div className="bg-zinc-50 min-h-screen font-sans pb-20">
      ...
      <div className="bg-white border-b border-zinc-200 py-12 text-left relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <h1 className="text-3xl font-extrabold text-zinc-950 tracking-tight">Marketplace Catalog</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 mt-10">
        ...
        {/* Filters Top bar */}
        <div className="bg-white border border-zinc-200 rounded-3xl p-5 shadow-xs flex flex-col md:flex-row gap-4 items-center justify-between">
          {/* Search Box */}
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-end">
            <span className="text-xs font-bold text-zinc-500 whitespace-nowrap">Sort By</span>
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="h-11 px-4 bg-zinc-50 border border-zinc-200 focus:border-indigo-650 rounded-2xl text-xs font-bold outline-none cursor-pointer"
            >
        ...
        <div className="relative w-full py-4 select-none group/scroll">
          ...
          >
            <button
              ...
              className={`px-4.5 py-2.5 rounded-full text-xs font-bold transition-all border whitespace-nowrap cursor-pointer ${
