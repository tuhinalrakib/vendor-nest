    ...
    <div className="bg-zinc-50 min-h-screen font-sans pb-20">
      ...
      <div className="bg-white border-b border-zinc-200 py-12 text-left relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <h1 className="text-3xl font-extrabold text-zinc-950 tracking-tight">Marketplace Departments</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 mt-10">
        ...
        {/* Search Bar filter */}
        <div className="bg-white border border-zinc-200 rounded-3xl p-5 shadow-xs flex items-center">
        ...
        {isLoading ? (
          <div className="py-24 flex flex-col items-center justify-center space-y-4">
            ...
            <span className="text-xs text-zinc-550 font-bold">Querying catalog departments...</span>
          </div>
        ) : filteredCategories.length === 0 ? (
          <div className="bg-white border border-zinc-200 rounded-3xl p-16 text-center mt-8 shadow-xs max-w-xl mx-auto space-y-4">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-extrabold text-zinc-950">No categories found</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            {filteredCategories.map((cat) => (
              <div
                key={cat.id}
                className="bg-white border border-zinc-205 hover:border-zinc-300 rounded-3xl p-6 text-left flex flex-col justify-between hover:shadow-xl transition-all duration-300 group relative overflow-hidden"
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left space-y-0.5">
                      <h3 className="text-base font-extrabold text-zinc-950 group-hover:text-indigo-650 transition-colors">
                        {cat.name}
                      </h3>
                  ...
                  {/* Description */}
                  <p className="text-xs sm:text-[13px] text-zinc-450 leading-relaxed font-semibold">
                    {cat.description}
                  </p>
                </div>
                ...
                <div className="mt-6 pt-5 border-t border-zinc-100">
                  <Link
                    ...
                    className="w-full h-11 rounded-2xl bg-zinc-50 hover:bg-indigo-650 hover:text-white text-zinc-800 border border-zinc-205 hover:border-transparent font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm hover:shadow-md active:scale-[0.98]"
                  >
