...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-zinc-50 dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 font-sans mt-auto transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-3.5">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/shops" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Browse Shops
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3.5">
            ...
            <ul className="space-y-2 text-sm">
              {(!isAuthenticated || user?.role === "customer") && (
                <li>
                  <Link href="/become-seller" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                    Become a Seller
                  </Link>
                </li>
              )}
              {isSeller && (
                <li>
                  <Link href="/seller/dashboard" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                    Seller Dashboard
                  </Link>
                </li>
              )}
              ...
              <li>
                <Link href="/seller/pricing" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Merchant Plans
                </Link>
              </li>
              <li>
                <Link href="/seller/faq" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Seller Resources
                </Link>
              </li>
            </ul>
        ...
        {/* Divider */}
        <div className="border-t border-zinc-200 dark:border-zinc-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-400 dark:text-zinc-500">
