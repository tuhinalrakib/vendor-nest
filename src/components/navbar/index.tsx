    ...
    <header className="fixed top-0 left-0 right-0 z-50 w-full">
      ...
      <nav className="w-full border-b border-zinc-200/70 dark:border-zinc-800/70 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl backdrop-saturate-150 shadow-xs transition-all duration-300">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 text-sm font-semibold text-zinc-650 dark:text-zinc-400">
            <Link
              href="/shops"
            ...
            {isLoading ? (
              ...
              user.role === "admin" ? (
                <Link href="/admin/dashboard" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-350 transition-colors font-bold px-2 py-1.5">
                  {t("nav.adminDashboard")}
                </Link>
              ) : user.role === "seller" ? (
                <Link href="/seller/dashboard" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-350 transition-colors font-bold px-2 py-1.5">
                  {t("nav.sellerDashboard")}
                </Link>
              ) : null
            ) : (
              <Link href="/become-seller" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-350 transition-colors font-bold px-2 py-1.5">
                {t("nav.becomeSeller")}
              </Link>
            )}
          </div>
          ...
          {isLoading ? (
            <div className="flex items-center gap-2 px-2.5 sm:px-3.5 py-1.5 rounded-full bg-zinc-50 border border-zinc-200/60 shadow-xs animate-pulse shrink-0">
            ...
            <div className="relative shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-1.5 sm:gap-2.5 p-1 sm:p-1.5 sm:pr-3 rounded-full hover:bg-zinc-50 border border-zinc-200/80 transition-all duration-200 text-left cursor-pointer active:scale-[0.98] shrink-0"
              >
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-linear-to-tr from-indigo-500 to-indigo-650 text-white flex items-center justify-center font-bold text-xs shadow-sm border border-indigo-400 shrink-0">
                  {getInitials()}
                </div>
          ...
          <button
            ...
            className="p-2 text-zinc-500 hover:text-zinc-900 rounded-xl hover:bg-zinc-100 transition-colors md:hidden active:scale-95 cursor-pointer shrink-0"
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className="absolute top-16 left-0 right-0 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-b border-zinc-200/50 dark:border-zinc-800/50 p-4 shadow-xl z-50 md:hidden animate-in slide-in-from-top-4 duration-200">
            ...
            {/* Mobile Language & Theme Quick Switcher */}
            <div className="flex items-center justify-between p-2.5 rounded-2xl bg-zinc-100/80 dark:bg-zinc-900/80 border border-zinc-200/60 dark:border-zinc-800/80 mb-3">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-zinc-600 dark:text-zinc-400">Language:</span>
                <div className="flex items-center border border-zinc-200 dark:border-zinc-750 rounded-xl overflow-hidden bg-white dark:bg-zinc-950 p-0.5 text-xs font-bold shadow-2xs">
                  <button
                    onClick={toggleLang}
                    className={`px-3 py-1 rounded-lg transition-all cursor-pointer ${lang === "en" ? "bg-indigo-600 text-white font-black shadow-xs" : "text-zinc-600 dark:text-zinc-400 hover:text-zinc-900"}`}
                  >
                    English
                  </button>
                  <button
                    onClick={toggleLang}
                    className={`px-3 py-1 rounded-lg transition-all cursor-pointer ${lang === "bn" ? "bg-indigo-600 text-white font-black shadow-xs" : "text-zinc-600 dark:text-zinc-400 hover:text-zinc-900"}`}
                  >
                    বাংলা
                  </button>
                </div>
              ...
              <button
                onClick={toggleTheme}
                className="p-1.5 px-3 rounded-xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 text-xs font-bold flex items-center gap-1.5 cursor-pointer shadow-2xs active:scale-95"
              >
             ...
             <div className="flex flex-col gap-1.5">
              <Link
                ...
                className={`px-4 py-2.5 rounded-xl text-sm font-extrabold transition-colors ${
                  isActive("/shops")
                    ? "bg-indigo-50 dark:bg-indigo-950/60 text-indigo-650 dark:text-indigo-400 border border-indigo-200/80 dark:border-indigo-800/60"
