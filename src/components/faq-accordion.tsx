              ...
              >
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] font-extrabold text-indigo-650 dark:text-indigo-400">
                      {faq.banglaQuestion}
                    </p>
                  </div>
                ...
                >
                  <div className="space-y-3 text-xs sm:text-sm font-semibold text-zinc-650 dark:text-zinc-400 leading-relaxed">
                    <p>{faq.answer}</p>
                    <p className="text-zinc-500 dark:text-zinc-400 font-bold border-l-2 border-indigo-600 pl-3.5 italic">
                      {faq.banglaAnswer}
                    </p>
                  </div>
                </div>
